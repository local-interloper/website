  ...
  return (
    <article className="flex flex-col items-center w-full gap-article">
      <DocumentHero title="Art" subtitle="(AKA renders of stuff I'm into)">
        <p>
          Me and visual art always had an interesting relationship. Originally I wanted to learn
          it to make video games but then ended up really enjoying just starting up Blender and
          working on something just for the sake of making something I can call pretty.
        </p>
        <p>
